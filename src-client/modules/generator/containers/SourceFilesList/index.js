...
class Container extends Component {
  ...
  handleSubmit(e) {
    ...
    console.log("安装文件的结果====", this.props);
        ...
        <Grid fluid={true}>
          ...
          <Row style={{ position: "relative" }}>
            <Col xs={12} md={4} sm={4} lg={4}>
              <div style={cellBoxStyle}>
                <div style={{ width: "100%", paddingTop: "2em" }}>
                  ...
                  <ListGroup>{fileItemsList}</ListGroup>
                  {dependenciesItem && (
                    <div>
                      <p>
                        <span>npm &amp; resources dependencies</span>
                      </p>
                      <ListGroup>{dependenciesItem}</ListGroup>
                    </div>
                  )}
                  <p>
                    <span>Structor specific files</span>
                  </p>
                  <ListGroup>{fileStructorItemsList}</ListGroup>
                  <div
                    style={{
                      marginTop: "2em",
                      display: "flex",
            ...
            <Col xs={12} md={8} sm={8} lg={8}>
              <div style={cellBoxStyle}>
                <div
                  style={{ width: "100%", height: "100%", paddingTop: "2em" }}
                >
                  <p>
                    <span>Source code preview</span>
                  </p>
                  <div ref="sourceCodePane">
                    <pre key={previewFilePath}>
                      <code>{previewSourceCode}</code>
                    </pre>
                  </div>
                </div>
              </div>
